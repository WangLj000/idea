...
int applypatch(int argc, char * argv[]) {
	...
	off_t lenread;
	off_t i;
	__android_log_print(ANDROID_LOG_INFO, "ApkPatchLibrary", "old = %d ", -6);
	if (argc != 4)
	...
	__android_log_print(ANDROID_LOG_INFO, "ApkPatchLibrary", "old = %d ", -5);
	/*
	 File format:
	 0	8	"BSDIFF40"
	 8	8	X
	...
	if (memcmp(header, "BSDIFF40", 8) != 0)
		errx(1, "Corrupt patch\n");
	__android_log_print(ANDROID_LOG_INFO, "ApkPatchLibrary", "old = %d ", -3);
	...
	if ((bzctrllen < 0) || (bzdatalen < 0) || (newsize < 0))
		errx(1, "Corrupt patch\n");
	__android_log_print(ANDROID_LOG_INFO, "ApkPatchLibrary", "old = %d ", 0);
	...
	while (newpos < newsize) {
		...
		__android_log_print(ANDROID_LOG_INFO, "ApkPatchLibrary", "old = %d ", 1);
		if ((lenread < ctrl[0])
	...
	__android_log_print(ANDROID_LOG_INFO, "ApkPatchLibrary", "old = %d ", 2);
